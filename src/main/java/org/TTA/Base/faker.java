...
public class faker {
    ...
    public static String country(){
        faker=new Faker();
        String uname=faker.country().name();
        return uname;
    }
    ...
    public static Integer randomno(){
        faker=new Faker();
        Integer up= Integer.valueOf(faker.number().numberBetween(2,9));
        return up;
    }
    public static Integer phoneno(){
        faker=new Faker();
        Integer up= Integer.valueOf(String.valueOf(faker.phoneNumber()));
        return up;
    }
